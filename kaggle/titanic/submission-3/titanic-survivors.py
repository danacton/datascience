...
columns = ['PassengerId', 'Pclass', 'Sex', 'Age', 'SibSp', 'Parch', 'Fare', 'Embarked', 'IsAdultMale', 'IsSouthamptonThirdClassCheapTickets']
...
write_image_of_decision_tree('submission-3-decision-tree', dtree, columns)

# Remove unnecessary columns from the test data
test_data = test_data.drop(['Cabin', 'Ticket', 'Name', 'Title'], axis=1) 
